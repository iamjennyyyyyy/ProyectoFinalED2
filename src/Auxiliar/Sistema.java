...
public class Sistema {
	...
	public static Sistema getInstancia(){
		if(instancia==null){
			...
			sistema = new GeneralTree<NodoSalud>();
	...
	public BinaryTreeNode<NodoSalud> buscarConsultorio(String consultorio){
		System.out.println("=== BUSCANDO CONSULTORIO ===");
	    System.out.println("Código buscado: " + consultorio);
	    System.out.println("sistema es null? " + (sistema == null));
	    
	    if(sistema == null) {
	        System.out.println("ERROR: sistema no inicializado");
	        return null;
	    }
	    
	    InBreadthIterator<NodoSalud> it = sistema.inBreadthIterator();
	    System.out.println("Iterador creado, tiene next? " + it.hasNext());
	    ...
	    while(it.hasNext() && con == null){
	        ...
	        System.out.println("Nodo #" + contador + ": " + 
	                          nodo.getClass().getSimpleName() + 
	                          " - Código: " + nodo.getCodigo());
	        
	        if(nodo instanceof Consultorio){
	            Consultorio c = (Consultorio)nodo;
	            System.out.println("  -> Es Consultorio: " + c.getCodigo());
	            if(c.getCodigo().equals(consultorio)){
	                con = nn;
	    ...
	    System.out.println("Total nodos recorridos: " + contador);
